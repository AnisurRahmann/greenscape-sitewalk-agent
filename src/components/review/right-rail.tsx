...
function InfoTip({ children, tip }: { children: ReactNode; tip: string }) {
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute left-0 top-full z-20 mt-1.5 w-64 rounded-lg bg-blue-600 px-3.5 py-3 text-sm leading-relaxed text-white opacity-0 shadow-xl transition-opacity duration-100 group-hover:opacity-100 group-focus:opacity-100"
      >
        {tip}
      </span>
    </span>
