...
First full run 2026-09-02 against `33b2b99`, `LLM_PROVIDER=openai` (gpt-4o
single-shot + extraction, gpt-4o-mini classify) — full output in
[evals/RESULTS.md](evals/RESULTS.md). The false-flag rate — items sent to human
review that were actually correct — is the headline metric, because it is the
cost of over-caution Marcus would pay reviewing a tool that flags too much.
